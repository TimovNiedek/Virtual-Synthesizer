...
{
	/// <summary>
	/// Should positioning be delegated?
	/// </summary>
	public bool delegatePositioning;
	...
	public delegate void UpdatePositioning(OVRPose leftPose, OVRPose rightPose, Transform left, Transform center, Transform right);
	public UpdatePositioning onPositioningUpdate;
...
#region Unity Messages
	...
	private void UpdateAnchors()
	{
		if (!delegatePositioning) {
			...
			if (onPositioningUpdate != null)
			{
				OVRPose leftEye = OVRManager.display.GetEyePose(OVREye.Left);
				OVRPose rightEye = OVRManager.display.GetEyePose(OVREye.Right);
				onPositioningUpdate(leftEye, rightEye, leftEyeAnchor, centerEyeAnchor, rightEyeAnchor);
